    ...
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
                <div className="relative flex shrink-0 h-40 md:h-28 lg:h-35 xl:h-40 w-full md:w-40 lg:w-64 xl:w-80 rounded-xl bg-slate-800 overflow-hidden hover:rounded-none transition-all ">
                    <img
